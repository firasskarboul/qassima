 ...
 */
class Category extends \Eshop\ShopBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eshop\\ShopBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Eshop\\ShopBundle\\Entity\\Category' . "\0" . 'slug', '' . "\0" . 'Eshop\\ShopBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Eshop\\ShopBundle\\Entity\\Category' . "\0" . 'description', '' . "\0" . 'Eshop\\ShopBundle\\Entity\\Category' . "\0" . 'metaKeys', '' . "\0" . 'Eshop\\ShopBundle\\Entity\\Category' . "\0" . 'metaDescription', '' . "\0" . 'Eshop\\ShopBundle\\Entity\\Category' . "\0" . 'children', '' . "\0" . 'Eshop\\ShopBundle\\Entity\\Category' . "\0" . 'parent', '' . "\0" . 'Eshop\\ShopBundle\\Entity\\Category' . "\0" . 'dateCreated', '' . "\0" . 'Eshop\\ShopBundle\\Entity\\Category' . "\0" . 'dateUpdated', 'path', 'file', '' . "\0" . 'Eshop\\ShopBundle\\Entity\\Category' . "\0" . 'products'];
        }

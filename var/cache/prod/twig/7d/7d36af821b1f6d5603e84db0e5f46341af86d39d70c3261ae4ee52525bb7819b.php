...
/* AdminBundle:Ads:index.html.twig */
class __TwigTemplate_df0dbca9a695fb19e2caacea84f7376dbc2afaa38d8903fe743e8b806d466b78 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "AdminBundle:Ads:index.html.twig"));

        $this->parent = $this->loadTemplate("@Admin/adminLayout.html.twig", "AdminBundle:Ads:index.html.twig", 1);
...
";
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        // line 10
        echo "    ";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Ads list"), "html", null, true);
        echo " - ";
...
";
    ...
    <p>
        <a href=\"";
        // line 16
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_Ads_new");
        echo "\">
            <span class=\"glyphicon glyphicon-plus\"></span>
            ";
        // line 18
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Create a new ADS"), "html", null, true);
        echo "
        </a>
    </p>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td>
                    <a href=\"";
            // line 35
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_Ads_show", ["id" => twig_get_attribute($this->env, $this->source, $context["entity"], "id", [], "any", false, false, false, 35)]), "html", null, true);
            echo "\">";
            ...
            echo "                </td>
                <td>
                    <a href=\"";
            // line 57
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_Ads_show", ["id" => twig_get_attribute($this->env, $this->source, $context["entity"], "id", [], "any", false, false, false, 57)]), "html", null, true);
            echo "\">";
            ...
            echo "</a><br>
                    <a href=\"";
            // line 58
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_Ads_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["entity"], "id", [], "any", false, false, false, 58)]), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return "AdminBundle:Ads:index.html.twig";
    }
...
{% block title %}
    {{ 'Ads list'|trans }} - {{ 'Administration panel'|trans }}
{% endblock title %}

{% block page_content -%}
    <h3>{{ 'Ads list'|trans }}</h3>
    <p>
        <a href=\"{{ path('admin_Ads_new') }}\">
            <span class=\"glyphicon glyphicon-plus\"></span>
            {{ 'Create a new ADS'|trans }}
        </a>
    </p>
    <table class=\"records_list table table-striped\">
        <thead>
        ...
        {% for entity in entities %}
            <tr>
                <td>
                    <a href=\"{{ path('admin_Ads_show', { 'id': entity.id }) }}\">{{ entity.name }}</a>
                </td>
                <td>
                    {% if entity.path %}
                ...
                <td>
                    <a href=\"{{ path('admin_Ads_show', { 'id': entity.id }) }}\">{{ 'show'|trans }}</a><br>
                    <a href=\"{{ path('admin_Ads_edit', { 'id': entity.id }) }}\">{{ 'edit'|trans }}</a>
                </td>
            </tr>
        {% endfor %}
        </tbody>
...
", "AdminBundle:Ads:index.html.twig", "C:\\laragon\\www\\qassiima\\src\\Eshop\\AdminBundle/Resources/views/Ads/index.html.twig");
    }
}

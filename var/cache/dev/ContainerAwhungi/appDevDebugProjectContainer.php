...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'app.email_notifier' => 'getApp_EmailNotifierService.php',
            'app.form.registration' => 'getApp_Form_RegistrationService.php',
            'app.page_utilities' => 'getApp_PageUtilitiesService.php',
            'app.site_settings' => 'getApp_SiteSettingsService.php',
            ...
            'eshop.upload_listener' => 'getEshop_UploadListenerService.php',
            ...
            'my.sitemap.listener' => 'getMy_Sitemap_ListenerService.php',
            ...
            'oneup_uploader.controller.gallery' => 'getOneupUploader_Controller_GalleryService.php',
            ...
            'oneup_uploader.storage.gallery' => 'getOneupUploader_Storage_GalleryService.php',
        ...
        $this->privates = [
            ...
            'app.email_notifier' => true,
            'app.form.registration' => true,
            'app.locale_listener' => true,
            'app.page_utilities' => true,
            'app.site_settings' => true,
            ...
            'presta_sitemap.dumper' => true,
            'presta_sitemap.eventlistener.route_annotation' => true,
            'presta_sitemap.generator' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('2soSeIjWAj', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sJ6WsCCHA9', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
     ...
     *
     * @return \Eshop\ShopBundle\EventListener\LocaleListener
     */
    protected function getApp_LocaleListenerService()
    {
        return $this->services['app.locale_listener'] = new \Eshop\ShopBundle\EventListener\LocaleListener('en');
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1TW0cdTR24', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NXfWDOnhsY', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dyE+RMRp9Y', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('presta_sitemap.populate', [0 => 'my.sitemap.listener', 1 => 'populateSitemap']);
        $instance->addListenerService('presta_sitemap.populate', [0 => 'presta_sitemap.eventlistener.route_annotation', 1 => 'populateSitemap']);
        $instance->addListener('oneup_uploader.post_upload', [0 => function () {
            return ${($_ = isset($this->services['eshop.upload_listener']) ? $this->services['eshop.upload_listener'] : $this->load('getEshop_UploadListenerService.php')) && false ?: '_'};
        }, 1 => 'onUpload'], 0);
        ...
        $instance->addListener('kernel.request', [0 => function () {
            return ${($_ = isset($this->services['app.locale_listener']) ? $this->services['app.locale_listener'] : ($this->services['app.locale_listener'] = new \Eshop\ShopBundle\EventListener\LocaleListener('en'))) && false ?: '_'};
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3351b4f958888440521a4079605079bf831c7888'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(['defaultPaginationTemplate' => 'KnpPaginatorBundle:Pagination:twitter_bootstrap_v3_pagination.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 5]);
    }
    ...
    {
        $this->services['monolog.handler.console'] = $instance = new \Symfony\Bridge\Monolog\Handler\ConsoleHandler(NULL, false, [64 => 200, 128 => 100, 32 => 300, 256 => 100]);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 1 => ${($_ = isset($this->services['hwi_oauth.authentication.provider.oauth.main']) ? $this->services['hwi_oauth.authentication.provider.oauth.main'] : $this->load('getHwiOauth_Authentication_Provider_Oauth_MainService.php')) && false ?: '_'};
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3351b4f958888440521a4079605079bf831c7888');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'ShopBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Eshop\\ShopBundle'),
                    'namespace' => 'Eshop\\ShopBundle',
                ],
                'UserBundle' => [
                    'parent' => 'FOSUserBundle',
                    'path' => ($this->targetDirs[3].'\\src\\Eshop\\UserBundle'),
                ...
                'AdminBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Eshop\\AdminBundle'),
                    'namespace' => 'Eshop\\AdminBundle',
                ],
                'OneupUploaderBundle' => [
                    'parent' => NULL,
            ...
            case 'swiftmailer.spool.default.file.path': $value = ($this->targetDirs[0].'/swiftmailer/spool/default'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'ShopBundle' => 'Eshop\\ShopBundle\\ShopBundle',
                'UserBundle' => 'Eshop\\UserBundle\\UserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle',
                'DoctrineMigrationsBundle' => 'Doctrine\\Bundle\\MigrationsBundle\\DoctrineMigrationsBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'LiipImagineBundle' => 'Liip\\ImagineBundle\\LiipImagineBundle',
                'AdminBundle' => 'Eshop\\AdminBundle\\AdminBundle',
            ...
            'kernel.secret' => '3351b4f958888440521a4079605079bf831c7888',
            ...
            'fos_user.model.user.class' => 'Eshop\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'Eshop\\UserBundle\\Form\\Type\\RegistrationType',
            ...
            'presta_sitemap.dumper_base_url' => 'http://localhost/',
